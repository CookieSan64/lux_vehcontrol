			...
			if IsPedInAnyVehicle(playerped, false) then
				...
				if GetPedInVehicleSeat(veh, -1) == playerped then
					...
					if GetVehicleClass(veh) == 18 then
						...
						--DisableControlAction(0, 47, false) -- INPUT_VEH_HORN	
						--DisableControlAction(0, 172, false) -- INPUT_CELLPHONE_UP 
						--DisableControlAction(0, 173, false) -- INPUT_CELLPHONE_DOWN
						--DisableControlAction(0, 174, false) -- INPUT_CELLPHONE_LEFT 
						--DisableControlAction(0, 175, false) -- INPUT_CELLPHONE_RIGHT 
						--DisableControlAction(0, 81, false) -- INPUT_VEH_NEXT_RADIO
						--DisableControlAction(0, 82, false) -- INPUT_VEH_PREV_RADIO
						--DisableControlAction(0, 19, false) -- INPUT_CHARACTER_WHEEL 
						--DisableControlAction(0, 85, false) -- INPUT_VEH_RADIO_WHEEL 
						--DisableControlAction(0, 80, false) -- INPUT_VEH_CIN_CAM 
